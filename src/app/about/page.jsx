        ...
        <section className="mb-10">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="text-gray-700 space-y-4">
              <p>
                Welcome to MyStore, designed and developed by Vikrant your premier destination for the latest trends in fashion. Founded with a vision to bring high-quality, stylish, and accessible clothing to everyone, we believe that fashion is more than just clothes – it's a form of self-expression.
              </p>
              <p>
